...
if __name__ == '__main__':
    ...
    parser.add_argument('--input1', default='HAAR_L', help='image, HAAR_H, HAAR_L, HAAR_HHL, HAAR_HLL')
    parser.add_argument('--sup_mark', default='20', help='1, 5, 10')
    parser.add_argument('--unsup_mark', default='80', help='1_20, 1_50, 1_80, 5_20, 5_50, 5_80, 10_20, 10_50, 10_80')
